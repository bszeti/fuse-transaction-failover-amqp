export "MAVEN_OPTS=-Dorg.slf4j.simpleLogger.log.bszeti.artemis.test=debug -Dorg.slf4j.simpleLogger.log.org.apache.qpid.jms=info -Dorg.slf4j.simpleLogger.log.org.springframework.jms.connection=info"
